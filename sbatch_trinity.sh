...
#SBATCH --mail-user=rosenbaum.g@northeastern.edu # Update to your user name!
...
mkdir -p /home/$USER/project/data/trinity_de_novo
cp -r results/trinity_de_novo /home/$USER/project/data/trinity_de_novo
cp results/trinity*stats.txt /home/$USER/project/data/
